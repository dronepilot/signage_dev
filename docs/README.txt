...
You should copy the "demo" folder into the D:/signage_dev/apps 
folder and add the following line at the end of the
D:/signage_dev/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "D:/signage_dev/apps/demo/conf/httpd-prefix.conf"
...
configuration in the "D:/signage_dev/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "D:/signage_dev/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"D:/signage_dev/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "D:/signage_dev/apps/demo/conf/httpd-vhosts.conf"
