...
bitnami-wampstack-7.0.22-1-windows-installer.exe
...
path will be a folder at C:\Bitnami\wampstack-7.0.22-1. If the destination 
...
C:\Bitnami\wampstack-7.0.22-1 and that you use port 80 for Apache and 3306 for MySQL.
